                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        $sql=mysql_query("select * from t_penggajian pg join t_pegawai p on (p.nip=pg.nip) join tb_jabatan j on (j.kode=p.id_jabatan) where kategori_jabatan like 'Staff Lain-Lain'");
