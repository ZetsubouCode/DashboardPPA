                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        ...
                        <div class="panel-body panel-form">
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="evaluasi" id="evaluasi" placeholder="Evaluasi" />
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="inskeh" id="inskeh" placeholder="Insentif Kehadiran" />
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="insfile" id="insfile" placeholder="Insentif File  Data" />
                                    </div>
                                </div>
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        ?>
                                            ...
                                            <td align="right"><?php echo 'Rp. '.number_format($data['Gaji Pokok']+$data['<80%']+$data['Kunjungan']+$data['Tutorial']+$data['Lesson Plan']+$data['Evaluasi Kinerja']+$data['Intensif Kehadiran']+$data['Intensif File Data']) ?></td>
                                                <td align="center">
                                                <a href='index.php?p=cetak_mentor&&no_penggajian=<?php echo $data['No']; ?>'class="btn btn-primary btn-icon btn-sm" title='Detail'><i class='glyphicon glyphicon-folder-open'></i></a>
                                                </td>
                                            </tr>
                                            <?php 
                                        }
