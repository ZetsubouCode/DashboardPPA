...
<!-- begin breadcrumb -->
            ...
            <li><a href="<?php echo "http://".$_SERVER['SERVER_NAME'].substr($_SERVER['REQUEST_URI'],0,strlen($_SERVER['REQUEST_URI'])-19);?>">Home</a></li>
				...
				<li class="active"> Komponen Gaji Staff</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Tambah Komponen Gaji Staff</h4>
                        </div>
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" data-parsley-validate="true" name="data_pengguna" action="./model/input_jabatanstaf.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_jabatan" data-live-search="true" data-style="btn-white" class="form-control selectpicker" >
                                             ...
                                             <?php
                                            include "config/config.php";
                                             $sql = mysql_query("SELECT * FROM tb_jabatan where kategori_jabatan='Staff' ORDER BY nama_jabatan ASC");
                                                if(mysql_num_rows($sql) != 0){
                                                    while($data = mysql_fetch_assoc($sql)){
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" type="number" name="kontribusi" placeholder="kontrbusi Gereja" />
                                    </div>
                                </div>
			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">List Komponen Gaji Staf</h4>
                        </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                     <?php
                                        ...
                                        $action = "model/hapus_jabatanstaf.php?";
                                        $i=0;
                                        $_SESSION['deleteTable']="tb_jabatan";
                                        $_SESSION['deleteUID']="kode";
                                        $_SESSION['action']=$action;
                                            $sql=mysql_query("select * from t_penggajian pg join t_pegawai p on (p.nip=pg.nip) join tb_jabatan j on (j.kode=p.id_jabatan) where kategori_jabatan like 'Staff'");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo 'Rp.'.number_format($data['kontribusi_gereja']); ?></td>
                                                <td><?php echo 'Rp.'.number_format($data['kontribusi_yci']); ?></td>
                                                <td align="center">
